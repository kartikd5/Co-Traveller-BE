...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['email', 'phone'], description: 'Type of identifier' }),
    (0, class_validator_1.IsEnum)(['email', 'phone']),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], SendOtpDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Email address or Phone number based on type' }),
    (0, class_validator_1.ValidateIf)(o => o.type === 'email'),
    (0, class_validator_1.IsEmail)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.ValidateIf)(o => o.type === 'phone'),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['email', 'phone'] }),
    (0, class_validator_1.IsEnum)(['email', 'phone']),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Provide name during signup if User is new', required: false }),
