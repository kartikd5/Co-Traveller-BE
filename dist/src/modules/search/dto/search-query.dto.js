...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['car', 'bus', 'train', 'flight'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['car', 'bus', 'train', 'flight']),
    __metadata("design:type", String)
], SearchQueryDto.prototype, "transportPreference", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Sort criteria. Example: -createdAt' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
